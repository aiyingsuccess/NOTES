function xdot = ODE_IP3_ER(t, x0, glu)
%ODE_IP3_ER The function that computes the ODES for the perisynaptic
%IP3-sensitive ER branches, where Ca is produced due to IP3-ER activation

%   The function solves the ODEs for Ca production due to IP3-sensitive ER activation. The terms of each
